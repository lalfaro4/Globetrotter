...
templates['flight-activity.hbs'] = template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "    <div class=\"round planner-activity-child-container\">\r\n"
    + ((stack1 = container.invokePartial(lookupProperty(partials,"planner/result-item"),(depth0 != null ? lookupProperty(depth0,"flight_offer_json_data") : depth0),{"name":"planner/result-item","data":data,"indent":"        ","helpers":helpers,"partials":partials,"decorators":container.decorators})) != null ? stack1 : "")
    + "    </div>\r\n";
},"3":function(container,depth0,helpers,partials,data) {
    return "    <div class=\"round planner-activity-child-container hidden\"></div>\r\n";
  ...
  return "<div class=\"planner-activity\" data-activity-id=\""
    ...
    + alias4(((helper = (helper = lookupProperty(helpers,"destination_airport_code") || (depth0 != null ? lookupProperty(depth0,"destination_airport_code") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"destination_airport_code","hash":{},"data":data,"loc":{"start":{"line":14,"column":91},"end":{"line":14,"column":119}}}) : helper)))
    + "\"\r\n                    list=\"planner-destination-airports-"
    + alias4(((helper = (helper = lookupProperty(helpers,"index") || (depth0 != null ? lookupProperty(depth0,"index") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"index","hash":{},"data":data,"loc":{"start":{"line":15,"column":55},"end":{"line":15,"column":64}}}) : helper)))
    + "\" placeholder=\"Destination\" />\r\n                <datalist type=\"datalist\" id=\"planner-destination-airports-"
    + alias4(((helper = (helper = lookupProperty(helpers,"index") || (depth0 != null ? lookupProperty(depth0,"index") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"index","hash":{},"data":data,"loc":{"start":{"line":16,"column":75},"end":{"line":16,"column":84}}}) : helper)))
    + "\"\r\n                    class=\"planner-destination-airports-datalist\"></datalist>\r\n\r\n                <input type=\"date\" class=\"round planner-activity-departure-date\" value=\""
    + alias4(((helper = (helper = lookupProperty(helpers,"departure_date") || (depth0 != null ? lookupProperty(depth0,"departure_date") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"departure_date","hash":{},"data":data,"loc":{"start":{"line":19,"column":88},"end":{"line":19,"column":106}}}) : helper)))
    ...
    + ((stack1 = lookupProperty(helpers,"if").call(alias1,(depth0 != null ? lookupProperty(depth0,"flight_offer_json_data") : depth0),{"name":"if","hash":{},"fn":container.program(1, data, 0),"inverse":container.program(3, data, 0),"data":data,"loc":{"start":{"line":25,"column":4},"end":{"line":31,"column":11}}})) != null ? stack1 : "")
    + "</div>";
