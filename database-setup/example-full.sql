...
SET @activity_lax_to_sfo_flight_offer_json_data = '{"type":"flight-offer","id":"1","source":"GDS","instantTicketingRequired":!1,"nonHomogeneous":!1,"oneWay":!1,"lastTicketingDate":"2021-07-27","numberOfBookableSeats":7,"itineraries":[{"duration":"PT1H22M","segments":[{"departure":{"iataCode":"LAX","terminal":"5","at":"2021-08-04T06:00:00"},"arrival":{"iataCode":"SFO","terminal":"1","at":"2021-08-04T07:22:00"},"carrierCode":"B6","number":"2836","aircraft":{"code":"320"},"operating":{"carrierCode":"B6"},"duration":"PT1H22M","id":"1","numberOfStops":0,"blacklistedInEU":!1}]}],"price":{"currency":"USD","total":"98.40","base":"78.14","fees":[{"amount":"0.00","type":"SUPPLIER"},{"amount":"0.00","type":"TICKETING"}],"grandTotal":"98.40"},"pricingOptions":{"fareType":["PUBLISHED"],"includedCheckedBagsOnly":!1},"validatingAirlineCodes":["B6"],"travelerPricings":[{"travelerId":"1","fareOption":"STANDARD","travelerType":"ADULT","price":{"currency":"USD","total":"98.40","base":"78.14"},"fareDetailsBySegment":[{"segmentId":"1","cabin":"ECONOMY","fareBasis":"ML7AUEL1","brandedFare":"DN","class":"L","includedCheckedBags":{"quantity":0}}]}]}';
