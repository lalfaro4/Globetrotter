...
ALTER TABLE GlobetrotterV1.photo ADD CONSTRAINT FKphoto844459 FOREIGN KEY (file_owner, `file`) REFERENCES GlobetrotterV1.`file` (owner, file_id) ON DELETE Cascade;
...
ALTER TABLE GlobetrotterV1.guest_to_trip_association ADD CONSTRAINT FKguest_to_t485335 FOREIGN KEY (trip) REFERENCES GlobetrotterV1.trip (trip_id) ON DELETE Cascade;
ALTER TABLE GlobetrotterV1.guest_to_trip_association ADD CONSTRAINT FKguest_to_t75167 FOREIGN KEY (`user`) REFERENCES GlobetrotterV1.`user` (user_id) ON DELETE Cascade;
...
ALTER TABLE GlobetrotterV1.activity ADD CONSTRAINT FKactivity206321 FOREIGN KEY (service_provider) REFERENCES GlobetrotterV1.service_provider (service_provider_id);
...
ALTER TABLE GlobetrotterV1.photo_album ADD CONSTRAINT FKphoto_albu611781 FOREIGN KEY (`user`) REFERENCES GlobetrotterV1.registered_user (`user`);
...
INSERT INTO GlobetrotterV1.currency_code(code, name) VALUES ('GBP', 'Pund Sterling');
